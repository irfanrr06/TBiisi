   ...
   <section id="container" >
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <a class="btn btn-compose" style="background-color:black;border-bottom:black">Gallery</a>
                              <div style="overflow-y: hidden; overflow-x: hidden; margin:10px; display:flex; justify-content:center">
                              <div class="html5gallery" style="max-height:700px; overflow:hidden; display:block;" data-skin="horizontal" data-width="390" data-height="250" data-resizemode="fit"><?php
      ...
      <footer class="site-footer">
          <div class="text-center">
              1811522002 - Irfan Rahmat Ramadhan
