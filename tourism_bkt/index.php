  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg" style="background-color:black;border-bottom:black" >
        ...
        <!--logo start-->
        <a href="index.php" class="logo"><b>WebGis Object Tourism (14 1811522002 Irfan Rahmat Ramadhan)</b></a>
        <div class="top-menu">
                      ...
                      <div class="col-md-12 col-sm-12 mb">
                        <div class="white-panel pns">
                          ...
                          <header class="panel-heading" style="float:left">
                            ...
                            <a class="btn btn-success" role="button" data-toggle="collapse" onclick="posisisekarang()" title="Current Position" style="margin-right:1px"   ><i class="fa fa-location-arrow" style="color:white;"></i></a>
                            <a class="btn btn-success" role="button" data-toggle="collapse" onclick="lokasimanual()" title=" Manual Position" style="margin-right:1px" ><i class="fa fa-map-marker" style="color:white;"></i></a>
                            ...
                            <script>
                              function legenda()
                                    ...
                                    var layer = new google.maps.FusionTablesLayer(
                                {
                                   query: {
                                   select: 'Location',
                                          from: 'AIzaSyDgpfxdQ0Ep_nieNjV64u4yXWeSFHAT4BE'
                                           },
                                            map: map
                                          });
                                  ...
                                  content.push('<p><div class="color d"></div>Culinary</p>');
                                  content.push('<p><div class="color e"></div>Small Industry</p>');
                                  content.push('<p><div class="color f"></div>Souvenir</p>');
                                  content.push('<p><div class="color g"></div>Hotel</p>');
                                  content.push('<p><div class="color h"></div>Restaurant</p>');
                                  content.push('<p><div class="color i"></div>WorshipPlace</p>');
                                  content.push('<p><div class="color j"></div>Tourism</p>');
                                  content.push('<p><div class="color k"></div>Angkot</p>');
                              ...
                              function hideLegenda() {
                                ...
                                $('#tombol').empty();
                                console.log("Success");
                                $('#tombol').append('<a class="btn btn-success" role="button" id="showlegenda" data-toggle="collapse" onclick="legenda()" title="Legend"style="margin-right:10px" ><i class="fa fa-eye"style="color:black;"></i></a>');
                              }
                ...
                <div id="view_kanan_table" class="col-md-4 col-sm-4 mb" style="margin-top:20px; display:block;"> 
                      <div class="white-panel pns" style="height: 510px;">
                        <header class="panel-heading" style=" width: 100%"  >
                          <label class="btn btn-compose" id="judul_table" style="background-color:black;border-bottom:black;color:white; margin: 0px;">Popular Tourism
                          </label>
                        </header>
                        ...
                        <div id="populertourism">
                          <div class="container2">
                            <div class="row2" >
                            <div class="mySlides">
                                <a href="" onclick="galleryreco('tw001')"><img src="../_foto/tw0012.jpg" style="width:100%"></a>
                                <div style="background-color: black"><label style="color:white">Jam Gadang</label></div>
                              </div>

                              <div class="mySlides">
                                <a href="" onclick="galleryreco('tw004')"><img src="../_foto/tw0041.jpg" style="width:100%"></a>
                                <div style="background-color: black"><label style="color:white">Lobang Jepang</label></div>
                              </div>

                              <div class="mySlides">
                                <a href="" onclick="galleryreco('tw006')"><img src="../_foto/tw0062.jpg" style="width:100%"></a>
                                <div style="background-color: black"><label style="color:white">Jembatan Limpapeh</label></div>
                              </div>
                                
                              <div class="mySlides">
                                <a href="" onclick="galleryreco('tw011')"><img src="../_foto/tw0112.jpg" style="width:100%"></a>
                                <div style="background-color: black"><label style="color:white">Taman Panorama dan Ngarai Sianok</label></div>
                              </div>
                            ...
                            <div class="row2">
                              ...
                              <div class="column">
                                <img class="demo cursor" src="../_foto/tw0062.jpg" style="width:100%" onclick="currentSlide(3)">
                              </div>
                              <div class="column">
...
<!-- batas akhir popular tourism clickable -->
                      ...
                      <div id="view_table_sekitar" class="col-md-4 col-sm-4 mb" style="display:none">
                        <div class="white-panel pns" style="height:510px">
                           <div class="white-header" style="height:40px;margin:20px;margin-top:0px;background:white;color:black">
                             <h5 class="btn btn-compose" id="head-angkot" style="background-color:black;border-bottom:black">Search Result Object Around</h5><!-- Search Results Object Around -->
                           </div>
                           <div class="row">
                             <div class="col-sm-6 col-xs-6"></div>
                           </div>
     ...
     <!--  <footer class="footer" style="background-color: black; color: white;height: 80px;">
        ...
        <div >
          <p ><a href="#" >Irfan Rahmat Ramadhan</a> - <a href="#" target="_blank">1811522002</a> &copy; 2020</p>
        </div>
