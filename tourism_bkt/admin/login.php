  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
		      <form class="form-login" action="act/login.php" method="post">
		        <h2 class="form-login-heading" style="background:black">sign in now</h2>
		        <div class="login-wrap">       
		            ...
		            <button class="btn btn-theme btn-block" type="submit" name="submit" style="background:black;border-color:black"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>
                <a href="../" class="btn btn-theme btn-block"style="background:black;border-color:black">Back
		        </div>
		      </form>	  	
