...
@$homepage = file_get_contents("http://localhost/postgresql_12/mailtemplate.php?token=@$token&user=@$username");
  ...
  @$mail->ErrorInfo;
    ...
    header('location:http://localhost/postgresql_12/hotel_bkt/admin/checkemailjo.php');
  }
